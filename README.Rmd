...
Contributions to the package are welcome. Please start by filing an [issue](https://github.com/eokodie/an/issues), outlining the bug you intend to fix or functionality you intend to add or modify.
